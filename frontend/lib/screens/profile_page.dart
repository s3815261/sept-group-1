        ...
        child: Container(
          ...
          child: ListView(
            children: [
              ...
              ListTile(
                leading: Icon(Icons.calendar_month, size: _drawerIconSize, color: Theme.of(context).accentColor,),
                title: Text('Book Appointment', style: TextStyle(fontSize: 17, color: Theme.of(context).accentColor),),
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) => BookingAppointment()));
                },
              ),
              ListTile(
                leading: Icon(Icons.sick_outlined, size: _drawerIconSize, color: Theme.of(context).accentColor,),
                title: Text('Add Symptoms', style: TextStyle(fontSize: 17, color: Theme.of(context).accentColor),),
                onTap: (){
