...
class LightModeTheme extends FlowTheme {
  late Color primaryColor = const Color(0xFF6C07EE);
  late Color secondaryColor = const Color(0xFF8A02AE);
  late Color tertiaryColor = const Color(0xFFDC54FE);
...
class DarkModeTheme extends FlowTheme {
  late Color primaryColor = const Color(0xFF6C07EE);
  late Color secondaryColor = const Color(0xFF8A02AE);
  late Color tertiaryColor = const Color(0xFFDC54FE);
  late Color alternate = const Color(0xFFFFFFFF);
